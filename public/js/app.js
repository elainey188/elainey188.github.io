...
import Jobs from '../../resources/js/components/pages/Jobs';
import Employers from '../../resources/js/components/pages/Employers';
import Login from '../../resources/js/components/pages/Login';
import Register from '../../resources/js/components/pages/Register';
import Upload from '../../resources/js/components/pages/Upload';
import MyProfile from '../../resources/js/components/pages/MyProfile';
import JobPostingPage from '../../resources/js/components/pages/post-job';
    ...
    <div className="App">
      <Router>
        ...
        <Routes>
          ...
          <Route path="/pages/post-job" element={<JobPostingPage />} />
